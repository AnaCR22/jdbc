...
import uo.ri.cws.application.service.contract.crud.commands.ListContractsOfMechanic;
...
public class ContractCrudServiceImpl implements ContractCrudService {
	...
	throws BusinessException {
        return executor.execute(new ListContractsOfMechanic(nif));
    }
	...
	return executor.execute(new ListAllContracts());
    }
